...
{
	ISimpleDictionary* pObject = (ISimpleDictionary*)pvInstance;
	HRESULT hr;
...
CBTypeInfo CBDispatch<ISimpleDictionary>::g_typeinfo(__uuidof(ISimpleDictionary), L"ISimpleDictionary", s_mData, 7, _Invoke);
