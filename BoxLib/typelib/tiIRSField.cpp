...
static CBTypeInfo::METHOD_ENTRY s_mData[] =
{
	...
	{L"Type", {0x00000002, NULL, NULL, FUNC_DISPATCH, INVOKE_PROPERTYGET, CC_STDCALL, 0, 0, 32, 0, {{{NULL}, VT_I4}}, 0}}
};
...
{
	IRSField* pObject = (IRSField*)pvInstance;
	HRESULT hr;
	...
	IF_INVOKE_PROPERTYGET(0x00000002)	//Type
	{
		if(cArgs1 > 0)
			return DISP_E_BADPARAMCOUNT;
...
CBTypeInfo CBDispatch<IRSField>::g_typeinfo(__uuidof(IRSField), L"IRSField", s_mData, 2, _Invoke);
